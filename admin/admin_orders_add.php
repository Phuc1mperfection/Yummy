...
<body>
    ...
    <center>
        <font color=red><?php echo $_SESSION["order_add_error"]; ?></font>
    </center>
    <form method=POST action="admin_orders_add_action.php">
        <table border=0 align=center width=400>
            ...
            <tr>
                ...
                <td><input type=datetime-local style="width:220px" value="<?php $ngayGioHienTai = date("Y-m-d\TH:i");
                                                                            echo $ngayGioHienTai; ?>" name=txtThoiGianDatHang></td>
            </tr>

            <tr>
                <td>Thời gian thanh toán:</td>
                <td><input type=datetime-local style="width:220px" value="<?php $ngayGioHienTai = date("Y-m-d\TH:i");
                                                                            echo $ngayGioHienTai; ?>" name=txtThoiGianThanhToan></td>
            </tr>
            <tr>
